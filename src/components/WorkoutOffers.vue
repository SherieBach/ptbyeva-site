...
#workoutOffers {
  ...
  .workoutOffers-container {
    ...
    .workoutOffers-columns {
      ...
      .workoutOffers-text-wrap {
        text-align: center;
      }
    }

    .offer-box2, .offer-box4 {
      height: 200px;
      width: 200px;
